...
// Handles the Contact page's general inquiry form. Requires RESEND_API_KEY
// (and optionally CONTACT_TO_EMAIL) to be set as an environment variable,
// see README for setup. Without it, the form fails gracefully with a 503
// so the UI can point people to call/email directly instead of silently
